...
/*
	This function toggles the visibility of the Just Writing Gutenberg section on the user profile page.
*/
function JustWritingToggleGutenbergGroups()
	{
	jQuery('[id^="JustWritingGutenbergGroup"]').toggle();
	}
	
/*
	This function shows all the advanced options and buttons and Gutenberg sections when the user clicks custom in the quick settings radio group.
*/
function JustWritingShowAdvancedGroups()
	{
	jQuery('[id^="JustWritingOptionGroup"]').show();
	jQuery('[id^="JustWritingButtonGroup"]').show();
	jQuery('[id^="JustWritingGutenbergGroup"]').show();
	}

/*
	This function hides all the advanced options and buttons and Gutenberg sections when the user clicks anything other than custom in the quick settings radio group.
*/
function JustWritingHideAdvancedGroups()
	{
	jQuery('[id^="JustWritingOptionGroup"]').hide();
	jQuery('[id^="JustWritingButtonGroup"]').hide();
	jQuery('[id^="JustWritingGutenbergGroup"]').hide();
	}
...
function JustWritingSetQuickOptions( optiontype )
	...
	if( optiontype == 'minimal' )
		...
		document.getElementById( 'just_writing_help' ).checked = false;
		document.getElementById( 'just_writing_separatoreight' ).checked = false;
		document.getElementById( 'just_writing_g_p_n' ).checked = false;
		document.getElementById( 'just_writing_g_p_n_l' ).checked = false;
		}
		...
		document.getElementById( 'just_writing_help' ).checked = false;
		document.getElementById( 'just_writing_separatoreight' ).checked = true;
		document.getElementById( 'just_writing_g_p_n' ).checked = true;
		document.getElementById( 'just_writing_g_p_n_l' ).checked = false;
		}
